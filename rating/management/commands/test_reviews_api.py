"""
Management command to test the reviews API.
"""
import json
import requests
...
class Command(BaseCommand):
    help = 'Test the reviews API'

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('Testing reviews API...'))
        ...
        try:
            ...
            url = f'http://127.0.0.1:8000/rating/ratings/reviewed_{user2.id}/'
            ...
            if response.status_code == 200:
                ...
                self.stdout.write(self.style.ERROR(f'API call failed with status code {response.status_code}'))
