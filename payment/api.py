...
def _process_paystack(payment: Payment, payload: InitiatePaymentSchema) -> str:
    ...
    data = {
        ...
        "callback_url": f"{getattr(settings, 'BACKEND_URL', 'http://localhost:8000')}/payment/verify/?gateway=paystack",
...
def _process_flutterwave(payment: Payment, payload: InitiatePaymentSchema) -> str:
    ...
    data = {
        ...
        "redirect_url": f"{getattr(settings, 'BACKEND_URL', 'http://localhost:8000')}/payment/verify/?gateway=flutterwave",
