"""
Webhook processor for payment webhooks.

This module provides utilities for processing payment webhooks.
"""
    ...
    for webhook in other_webhooks:
        try:
            ...
            if result.get("status") == "error":
                mark_webhook_failed(webhook_id, result.get("message", "Unknown error"))
            else:
