...
class Payment(models.Model):
    ...
    #     pass  # you can add extra logic here (e.g., send receipt email)
    ...
    def mark_as_successful(self):
        ...
        from jobs.models import Job
        job = Job.objects.get(pk=self.job.pk)  # always fetch fresh copy
        ...
        logger.info(f"✅ Job {job.pk} marked as PAID and set to {job.status}")
